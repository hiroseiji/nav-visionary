...
export function SentimentTrend({
  ...
  const sentimentChartRef = useRef<ChartJS<"line", number[], string> | null>(null);
  const volumeChartRef = useRef<ChartJS<"bar", number[], string> | null>(null);
          ...
          data: {
            ...
            datasets: [
              ...
              },
              {
                ...
                pointHitRadius: Math.max(6, basePointRadius * 2),
                pointBackgroundColor: (ctx: { dataIndex: number }) => colorAt(ctx.dataIndex),
                pointHoverBackgroundColor: (ctx: { dataIndex: number }) => colorAt(ctx.dataIndex),
