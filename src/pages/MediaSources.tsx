...
export default function MediaSources() {
  ...
  const handleDeleteSource = async (id: string) => {
    if (!window.confirm("Are you sure you want to delete this media source?")) return;
    try {
      await axios.delete(
  ...
  const uniqueTypes = Array.from(new Set(sources.map(s => s.type).filter(Boolean)));
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>Domain/Handle</TableHead>
